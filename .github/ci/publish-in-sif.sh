...
# (project=newb, owner=ywatanabe1989, repo=newb,
...
TMPDIR="/tmp/publish-newb-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: newb dist/* uploaded to PyPI via manual OIDC trusted publishing"
